...
public class TopInvestors extends JPanel {

	private JLabel topInvestorsLabel;
	private JTable table;
	private JScrollPane tableSP;
	private TopInvestorsTableModel tableModel;

	public TopInvestors() {
		topInvestorsLabel = new JLabel("Top Investors");

		tableModel = new TopInvestorsTableModel();
