...
public class ManagePaymentsReceivableTablePanel extends JPanel{
	...
	private void setDesign() {
		...
		paymentReceivableLabel.setFont(new Font("montserrat", Font.PLAIN, size));
		paymentReceivableLabel.setHorizontalAlignment(SwingConstants.CENTER);
	}
